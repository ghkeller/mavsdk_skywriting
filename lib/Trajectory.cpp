...
namespace mavsdk_skywriting
{
    ...
    bool Trajectory::reached_waypoint(Offboard::PositionNedYaw pos, mavsdk::Telemetry &telemetry, float _wp_hit_thres) {
    ...
    bool Trajectory::reached_waypoint(Offboard::PositionNedYaw pos, mavsdk::Telemetry &telemetry,
    ...
    void TrajNoPref::traverse(mavsdk::Offboard &offboard,
    ...
    void TrajStraight::traverse(mavsdk::Offboard &offboard,
    ...
    // this is a blocking function
    void TrajCurved::traverse(mavsdk::Offboard &offboard,
            mavsdk::Telemetry &telemetry,
            float _wp_hit_thres, float _speed) {
